#
# Be sure to run `pod lib lint GHQuotationModule.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'GHQuotationModule'
  s.version          = '0.1.0'
  s.summary          = 'A short description of GHQuotationModule.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'GHQuotationModule' => ['GHQuotationModule/Assets/*.png']
  # }
